    ...
    var exports = {
        ...
        updateGroupListFunc : function(data){
            ...
            for(group in data){
                ...
                rtpl += '<button type="button" class="btn btn-sm btn-success mr" group="'+ group +'">'+ group +'</button>';
        ...
        addGroupFunc : function(){
            ...
            var groupBtnTpl = '<button type="button" class="btn btn-sm btn-success mr" group="group'+ pgName +'">group' + pgName + '</button>';
