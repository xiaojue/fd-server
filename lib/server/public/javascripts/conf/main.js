...
define('conf/main',function(require,exports,module){
    ...
    var exports = {
        ...
        delegateEvent : function(){
            ...
            $("#hostWrap").on('click',this.showHideHostFunc);
                ...
                hgtpl += '<div class="panel">'+
                                ...
                                '<div class="panel-body panel-content" id="'+ name +'">'+
                                    ...
                                    for(var i = 0;i < data[name].length; i++){
                                        ...
                                        if(check){
                                            hgtpl += '<tr><td class="ipt_pl"><input type="checkbox"></td><td>'+ data[name][i].ip +'</td><td>'+ data[name][i].domain +'</td><td><button type="button" class="btn btn-xs btn-info Wpr" editrule="1">编辑</button><button type="button" class="btn btn-xs btn-danger" deleterule="1">删除</button></td></tr>';
                                        }else{
                                            hgtpl += '<tr><td class="ipt_pl"><input type="checkbox" checked></td><td>'+ data[name][i].ip +'</td><td>'+ data[name][i].domain +'</td><td><button type="button" class="btn btn-info btn-xs Wpr" editrule="1">编辑</button><button type="button" class="btn btn-xs btn-danger" deleterule="1">删除</button></td></tr>';
                                        }   
                                    }
                                    hgtpl += '</table>'+
