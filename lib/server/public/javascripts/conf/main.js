    ...
    var exports = {
        ...
        updateHostsGroupFunc: function(data){
            ...
            for(name in data){
                ...
                hgtpl += '<div class="panel">'+
                                '<div class="panel-heading panel-head clearfix">'+
                                    '<span class="groupname"><input type="text" value="'+ name +'" class="form-control iptgroup" disabled="disabled" hg="1"/></span><button type="button" class="btn btn-xs btn-info" editgname = '+ name +'>编辑组名</button> <button type="button" class="btn btn-xs btn-info" deleteGroup = '+ name +'>删除此规则组</button>'+
                                '</div>'+
        ...
        addHostGroupFunc : function(){
            ...
            var hostGroupTpl = [
                '<div class="panel">',
                    '<div class="panel-heading panel-head clearfix">',
                        '<span class="groupname"><input type="text"  hg="1" value="group'+ hgname +'" class="form-control iptgroup" disabled="disabled" /></span><button type="button" class="btn btn-xs btn-info" editgname = "group'+ hgname +'">编辑组名</button> <button type="button" class="btn btn-xs btn-info" deleteGroup = "group'+ hgname +'">删除此规则组</button>',
                    '</div>',
