...
define('conf/main',function(require,exports,module){
    ...
    var exports = {
        ...
        //     var text1 = exports.getNode.srcUrl.val();
        //     var text2 = exports.getNode.urlTo.val();
        ...
        // updateServerListFunc : function(data,datac){
        //     if (data && JSON.stringify(data.vhost) != "{}") {
        //         stpl = '';
        //         stpl = '<table class="table table-condensed setmb" id="serverWrap">';
        //         for(var i in data.vhost){
        //             if (datac && datac.vhost) {
        //                 if (datac.vhost[i] === data.vhost[i]) { 
        //                     var disTpl = '<button type="button" class="btn btn-xs btn-info" disablerule='+ i +'>已开启</button>';
        //                 }else{ 
        //                     var disTpl = '<button type="button" class="btn btn-xs" disablerule='+ i +'>已禁用</button>';
        //                 }
        //             }
        //             stpl += '<tr>'+
        //                         '<td>'+ i +'</td>'+
        //                         '<td>'+ data.vhost[i]+'</td>'+
        //                         '<td>'+
        //                             '<button type="button" class="btn btn-xs btn-danger Wpr" severrule='+ i +'>删除</button>'+ disTpl +
        //                         '</td>'+
        //                     '</tr>';
        //         }
        //         stpl +='</table>';
        ...
        //     }else{
        //         stpl = '<table class="table table-condensed setmb" id="serverWrap" style="display:none;"></table>';    
        //     }
        // },
